...
In this case, you can create own TypeScript class or Angular component and bundle it into the HAOBO ACH UI code.
...
Some HAOBO ACH widgets already use this approach. Take a look at the [widget-component-service.ts{:target="_blank"}](https://github.com/thingsboard/thingsboard/blob/2627fe51d491055d4140f16617ed543f7f5bd8f6/ui-ngx/src/app/modules/home/components/widget/widget-component.service.ts#L140)
...
Here you can find how some bundled classes or components are registered for later use in HAOBO ACH widgets.
